...
public class Cardapio {
    ...
    public Cardapio(ArrayList<ItemCardapio> itens) { this.itens = itens; }

    public ArrayList<ItemCardapio> getItens() { return itens; }
    public void setItens(ArrayList<ItemCardapio> itens) { this.itens = itens; }

    public void adicionarItem(ItemCardapio item) { itens.add(item); }
    public void removerItem(ItemCardapio item) { itens.remove(item); }
    public ArrayList<ItemCardapio> listarItens() { return itens; }
